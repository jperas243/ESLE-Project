...
ssh -o StrictHostKeyChecking=accept-new $SERVER_IP_1 sudo docker run -d --name=roach1 --hostname=roach1 -p 26258:26258 -p 26257:26257 -p 26357:26357 -p 8080:8080 cockroachdb/cockroach:v23.1.11 start --advertise-addr=$SERVER_IP_1 --join=$SERVER_IP_1,$SERVER_IP_2,$SERVER_IP_3 --cache=$CACHE --max-sql-memory=$MAX_SQL_MEMORY --insecure 

ssh -o StrictHostKeyChecking=accept-new $SERVER_IP_2 sudo docker run -d --name=roach1 --hostname=roach1 -p 26258:26258 -p 26257:26257 -p 26357:26357 -p 8080:8080 cockroachdb/cockroach:v23.1.11 start --advertise-addr=$SERVER_IP_2 --join=$SERVER_IP_1,$SERVER_IP_2,$SERVER_IP_3 --cache=$CACHE --max-sql-memory=$MAX_SQL_MEMORY --insecure

ssh -o StrictHostKeyChecking=accept-new $SERVER_IP_3 sudo docker run -d --name=roach1 --hostname=roach1 -p 26258:26258 -p 26257:26257 -p 26357:26357 -p 8080:8080 cockroachdb/cockroach:v23.1.11 start --advertise-addr=$SERVER_IP_3 --join=$SERVER_IP_1,$SERVER_IP_2,$SERVER_IP_3 --cache=$CACHE --max-sql-memory=$MAX_SQL_MEMORY --insecure 
...
CONNECTION_STRING_TOT="${CONNECT_STRING1} ${CONNECT_STRING2} ${CONNECT_STRING3}" # This variable counts as 3 variables when using it
...
ssh -o StrictHostKeyChecking=accept-new $SERVER_IP_BENCHMARK sudo docker run --rm --name=roach1 --hostname=roach1 -p 26257:26257 -p 26357:26357 -p 8080:8080 cockroachdb/cockroach:v23.1.11 workload run kv --concurrency=128 --duration=1m --display-every=30s --tolerate-errors $CONNECTION_STRING_TOT > ./benchmarks/scalability_test/3_nodes/benchmark-test-$(date +%F_%H-%M-%S)""
ssh -o StrictHostKeyChecking=accept-new $SERVER_IP_BENCHMARK sudo docker run --rm --name=roach1 --hostname=roach1 -p 26257:26257 -p 26357:26357 -p 8080:8080 cockroachdb/cockroach:v23.1.11 workload run kv --concurrency=128 --duration=1m --display-every=30s --tolerate-errors $CONNECTION_STRING_TOT > ./benchmarks/scalability_test/3_nodes/benchmark-test-$(date +%F_%H-%M-%S)""
ssh -o StrictHostKeyChecking=accept-new $SERVER_IP_BENCHMARK sudo docker run --rm --name=roach1 --hostname=roach1 -p 26257:26257 -p 26357:26357 -p 8080:8080 cockroachdb/cockroach:v23.1.11 workload run kv --concurrency=128 --duration=1m --display-every=30s --tolerate-errors $CONNECTION_STRING_TOT > ./benchmarks/scalability_test/3_nodes/benchmark-test-$(date +%F_%H-%M-%S)""
ssh -o StrictHostKeyChecking=accept-new $SERVER_IP_BENCHMARK sudo docker run --rm --name=roach1 --hostname=roach1 -p 26257:26257 -p 26357:26357 -p 8080:8080 cockroachdb/cockroach:v23.1.11 workload run kv --concurrency=128 --duration=1m --display-every=30s --tolerate-errors $CONNECTION_STRING_TOT > ./benchmarks/scalability_test/3_nodes/benchmark-test-$(date +%F_%H-%M-%S)""
ssh -o StrictHostKeyChecking=accept-new $SERVER_IP_BENCHMARK sudo docker run --rm --name=roach1 --hostname=roach1 -p 26257:26257 -p 26357:26357 -p 8080:8080 cockroachdb/cockroach:v23.1.11 workload run kv --concurrency=128 --duration=1m --display-every=30s --tolerate-errors $CONNECTION_STRING_TOT > ./benchmarks/scalability_test/3_nodes/benchmark-test-$(date +%F_%H-%M-%S)""
