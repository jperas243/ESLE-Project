...
CONNECTION_STRING_TOT="${CONNECT_STRING1} ${CONNECT_STRING2} ${CONNECT_STRING3} ${CONNECT_STRING4} ${CONNECT_STRING5} ${CONNECT_STRING6} ${CONNECT_STRING7} ${CONNECT_STRING8} ${CONNECT_STRING9} ${CONNECT_STRING10} ${CONNECT_STRING11} ${CONNECT_STRING12}"
...
ssh -o StrictHostKeyChecking=accept-new $SERVER_IP_BENCHMARK sudo docker run --rm --name=roach1 --hostname=roach1 -p 26257:26257 -p 26357:26357 -p 8080:8080 cockroachdb/cockroach:v23.1.11 workload run kv --concurrency=512 --duration=1m --display-every=30s --tolerate-errors $CONNECTION_STRING_TOT > ./benchmarks/scalability_test/12_nodes/benchmark-test-$(date +%F_%H-%M-%S)""
ssh -o StrictHostKeyChecking=accept-new $SERVER_IP_BENCHMARK sudo docker run --rm --name=roach1 --hostname=roach1 -p 26257:26257 -p 26357:26357 -p 8080:8080 cockroachdb/cockroach:v23.1.11 workload run kv --concurrency=512 --duration=1m --display-every=30s --tolerate-errors $CONNECTION_STRING_TOT > ./benchmarks/scalability_test/12_nodes/benchmark-test-$(date +%F_%H-%M-%S)""
ssh -o StrictHostKeyChecking=accept-new $SERVER_IP_BENCHMARK sudo docker run --rm --name=roach1 --hostname=roach1 -p 26257:26257 -p 26357:26357 -p 8080:8080 cockroachdb/cockroach:v23.1.11 workload run kv --concurrency=512 --duration=1m --display-every=30s --tolerate-errors $CONNECTION_STRING_TOT > ./benchmarks/scalability_test/12_nodes/benchmark-test-$(date +%F_%H-%M-%S)""
ssh -o StrictHostKeyChecking=accept-new $SERVER_IP_BENCHMARK sudo docker run --rm --name=roach1 --hostname=roach1 -p 26257:26257 -p 26357:26357 -p 8080:8080 cockroachdb/cockroach:v23.1.11 workload run kv --concurrency=512 --duration=1m --display-every=30s --tolerate-errors $CONNECTION_STRING_TOT > ./benchmarks/scalability_test/12_nodes/benchmark-test-$(date +%F_%H-%M-%S)""
ssh -o StrictHostKeyChecking=accept-new $SERVER_IP_BENCHMARK sudo docker run --rm --name=roach1 --hostname=roach1 -p 26257:26257 -p 26357:26357 -p 8080:8080 cockroachdb/cockroach:v23.1.11 workload run kv --concurrency=512 --duration=1m --display-every=30s --tolerate-errors $CONNECTION_STRING_TOT > ./benchmarks/scalability_test/12_nodes/benchmark-test-$(date +%F_%H-%M-%S)""
